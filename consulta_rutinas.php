...
<head>
    ...
    function editarFila(enlace) {
        ...
        const fecha_creacionVal = fecha_creacion.textContent.trim();
                ...
                <tbody>
                    <?php foreach ($respuesta as $fila): ?>
                        <tr>
                            ...
                            <td class="titulo"><?= $fila[2] ?></td>
                            <td class="descripcion"><?= $fila[3] ?></td>
                            <td class="nivel"><?= $fila[4] ?></td>
                            <td class="dias_por_semana"><?= $fila[5] ?></td>
                            <td class="fecha_creacion"><?= $fila[6] ?></td>
